                ...
                <div class="sidebar content-box" style="display:block;">
                    <ul class="nav">
                        ...
                        <li><a <?php 
                                ...
                                $fecha = date('Y-m-d');
                                $queryFecha = "SELECT MAX(PeriodoFin) FROM listacandidatos WHERE Facultad = '".$_SESSION['Facultad']."' AND Sede = '".$_SESSION['Sede']."' AND IdTipoElecciones = '$tipoDecano'"; 
                                $resultadoFecha = mysqli_query($conexion ,$queryFecha); 
                                $rowFecha = mysqli_fetch_row($resultadoFecha); 
                                if($rowFecha[0] > $fecha){ ?>
                                    href="indexRector.php"<?php
                                }else{
                                    ?> href="indexDecanoMensaje.php" 
                        ...
                        <li class="current"><a <?php 
                            ...
                            if ($rowFecha[0] >= $fecha) {
                                ...
                                ?> href="indexVotacionMensajeDecano.php" <?php
                            }
