                            ...
                            <ul class="nav nav-pills card-header-pills">
                                <li class="nav-item">
                                    <a class="nav-link" aria-current="true" href="#">
                                        <p>Matrícula<br>Actual</p><i class="bi bi-calendar3"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" aria-current="true" href="#">
                                        <p>Matrícula<br>por Curricula</p><i class="bi bi-file-earmark-text"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" aria-current="true" href="#">
                                        <p>Matrículas<br>Realizadas</p><i class="bi bi-grid-3x3-gap-fill"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="true" href="#">
                                        <p>Datos<br>Generales</p><i class="bi bi-person-fill"></i></a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
