                ...
                <div class="sidebar content-box" style="display: block;">
                    <ul class="nav">
                        ...
                        <li><a <?php 
                                date_default_timezone_set('America/Lima');
                                $fecha = date('Y-m-d');
                                $queryFecha = "SELECT MAX(PeriodoFin) FROM listacandidatos WHERE IdTipoElecciones = '$tipoDirectorPostgrado'";//filtrar también por tipo 
                                ...
                                if($rowFecha[0] >= $fecha){ ?>
                                    ...
                                    ?> href="indexVotacionMensajePosgrado.php" 
