...
<body>
    ...
    <center>
            <h1 style="color: white; background: rgb(0,0,0,.6); border-radius:15px; padding:10px; margin-top:10px;"><img src="../img/undac.png" alt="" width="80" height="80"> Consejo De Facultad <img src="../img/undac.png" alt="" width="80" height="80"></h1>
        </center>
        <div class="row">
            <div class="col-md-2">
                <div class="sidebar content-box" style="display:block;">
                    <ul class="nav">
                        ...
                        <li><a <?php 
                                ...
                                if($rowFecha[0] >= $fecha){ ?>
                                    href="indexDirectorPosgrado.php"<?php
                                }else{
                                    ?> href="indexRectorMensaje.php" 
                                <?php } ?>><i class="glyphicon glyphicon-info-sign"></i>Información Candidatos</a></li>
                        <li class="current"><a href="indexVotarPosgrado.php"><i class="glyphicon glyphicon-ok"></i> Realizar Votación</a></li>
                        <li><a <?php 
            ...
            <div class="col-md-6">
                ...
                <?php
                    ...
                    $query = "SELECT*FROM integrantelistacandidatos WHERE IdListaCandidato IN (SELECT IdListaCandidato FROM listacandidatos WHERE PeriodoFin >= '".$FechaHoy."') AND IdTipoElecciones = '$tipoDirectorPostgrado'";
                        ...
                        <div class="content-box-large">
                            ...
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4><strong>Cargo: </strong>Postgrado(a) de <?php 
                            ...
                            <center>
                                ...
                                <br> 
                                        ...
                                        <a href="" type="button" class="btn btn-primary openBtn" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="Descripcion(this)" id="<?php echo $row[2];?>">►Elegir</a>
                                        <br><br>
                                        <!-- Modal -->
                            ...
                            <script>  
                                ...
                                $('.modal-body').load('cantidadVotosPosgrado.php?id='+codigo,function(){
