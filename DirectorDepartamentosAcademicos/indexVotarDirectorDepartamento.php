            ...
            <div class="col-md-2">
                <div class="sidebar content-box" style="display:block;">
                    <ul class="nav">
                        ...
                        <li class="current"><a href="indexVotarDirectorDepartamento.php"><i class="glyphicon glyphicon-ok"></i> Realizar Votación</a></li>
                        <li><a <?php 
                    ...
                    <div class="col-md-6">
                        <div class="content-box-large">
                            ...
                            <script>  
                                ...
                                $('.modal-body').load('cantidadVotosDirectorDepartamento.php?id='+codigo,function(){
