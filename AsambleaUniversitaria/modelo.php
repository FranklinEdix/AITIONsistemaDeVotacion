...
class Modelo_Grafico{
    ...
    {   
        ...
        $sql ="SELECT partido.NombrePartido, CantidadVotos FROM listacandidatos INNER JOIN partido ON listacandidatos.IdPartido = partido.IdPartido WHERE PeriodoFin= (SELECT MAX(PeriodoFin) FROM listacandidatos WHERE IdListaCandidato IN(SELECT IdListaCandidato FROM integrantelistacandidatos WHERE IdTipoElecciones='$tipoAsamblea')) AND IdTipoElecciones='$tipoAsamblea' ORDER BY CantidadVotos DESC";//listaRector
